...
final class StreamableHttpHandler {
	...
	private function generate_dynamic_instructions(): string {
		...
		$instructions = "Bricks MCP connects AI assistants to a WordPress site running Bricks Builder.\n\n"
			...
			. "3. Call get_builder_guide(section='workflow') - Learn the complete page-building methodology\n"
			. "4. Call get_builder_guide(section='gotchas') - Learn corrections and common mistakes to avoid\n"
			. "5. Call page:get(view='describe') on a similar existing page - Study patterns before building\n\n"
			. "CRITICAL REMINDERS:\n"
