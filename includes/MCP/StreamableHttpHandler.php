...
final class StreamableHttpHandler {
	...
	private function generate_dynamic_instructions(): string {
		...
		$instructions = "Bricks MCP connects AI assistants to a WordPress site running Bricks Builder.\n\n"
			...
			. "   Step 3 — BUILD: Take the suggested_schema, replace [PLACEHOLDER] content with real text.\n"
			. "   Call build_from_schema(proposal_id, schema). Do NOT modify structure or style_overrides.\n\n"
			. "   Step 4 — VERIFY: Call verify_build(page_id) to confirm the result matches your design intent.\n"
