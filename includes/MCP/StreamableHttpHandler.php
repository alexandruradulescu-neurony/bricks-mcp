...
final class StreamableHttpHandler {
	...
	private function generate_dynamic_instructions(): string {
		...
		$instructions = "Bricks MCP connects AI assistants to a WordPress site running Bricks Builder.\n\n"
			...
			. "3. DESIGN BUILD → use propose_design then build_from_schema\n"
			...
			. "   Steps: call propose_design(page_id, description) → use the returned suggested_schema as your starting point → replace [PLACEHOLDER] content with real text → call build_from_schema(proposal_id, schema)\n"
			. "   CRITICAL: Do NOT write schemas from scratch. The suggested_schema has correct hierarchy, class_intents, style_overrides, and patterns. Only modify content.\n\n"
			. "ENFORCEMENT:\n"
